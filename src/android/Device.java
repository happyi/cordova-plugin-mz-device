...
public class Device extends CordovaPlugin {
    ...
    public String getSingInfo() {
        try {
            ...
            String tmp = null;
            PackageInfo packageInfo = this.cordova.getContext().getPackageManager().getPackageInfo(this.cordova.getActivity().getPackageName(), PackageManager.GET_SIGNATURES);
